...
@section('konten')
    ...
    <h1 class="text-center mb-4">Edit Data Fasilitator</h1>  <!-- Judul Konten -->
    ...
    <div class="card">
            ...
            <form>
                <div class="mb-3">
                  ...
                  <input type="text" name="NIDN" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{$data->NIDN}}">
                </div>
                <div class="mb-3">
