...
<!-- Formulir untuk menambahkan data peserta -->
    <form action='{{ url('peserta') }}' method='post'>
        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="number" class="form-control" name='nim' value="" id="nim">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name='nama_lengkap' value="" id="nama_lengkap">
                </div>
            </div>
...
<div class="row mb-3">
    <div class="col-sm-10 offset-sm-2"> <!-- Menggunakan offset untuk membuat kolom button tergeser -->
        <button type="submit" class="btn btn-primary mr-5" name="submit">SIMPAN</button>
